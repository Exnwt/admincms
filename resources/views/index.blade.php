...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script <?php include 'C:\laravel\gudangapps\vendor\chart.js\Chart.min.js'?>></script>

    <!-- Page level custom scripts -->
    <script <?php include 'C:\laravel\gudangapps\resources\js\demo\chart-area-demo.js'?>></script>
    <script <?php include 'C:\laravel\gudangapps\resources\js\demo\chart-pie-demo.js'?>></script>
