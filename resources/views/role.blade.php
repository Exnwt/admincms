        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Role Access</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <form action="">
                                @csrf
                                <select name="account_id" id="account_id" class="btn btn-primary" onclick="getAutotype()">
                                    <option value="0">-- Choose Account --</option>
                                    @foreach($rolee as $rol)
...
<script>
    ...
    let role = []
        ...
        const authoo = await response.json();
